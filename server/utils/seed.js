...
const testRecipes = [
  {
    ...
    instructions:
      "Measure all ingredients except oil, and mix together in blender. Drizzle oil while blender is running to emulsify. Store in airtight container in fridge for up to 2 weeks.",
    category: "Dressing",
    rating: 5,
  },
];
